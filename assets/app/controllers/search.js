...
angular.module('DojoApp.controllers')
    .controller('SearchController', ['$scope', '$http', '$routeParams', '$resource', '$q', '$filter', 'spinnerService', '$window', '$location', '$log', 'PropertyService', 'userInfo', 'csrfToken', 'configuration', 'websocket', '$timeout', function(
                                      $scope,   $http,   $routeParams,   $resource,   $q,   $filter,   spinnerService,   $window,   $location,   $log,   PropertyService,   userInfo,   csrfToken,   configuration,   websocket,   $timeout) {
        ...
        $scope.$watch(function() { return $scope.v.viewType; }, function(newValue, oldValue) {
    ...
    .controller('PropertyListViewCtrl', ['$scope', '$timeout', '$http', '$templateCache', '$compile', '$filter', function(
                                          $scope,   $timeout,   $http,   $templateCache,   $compile,   $filter) {
